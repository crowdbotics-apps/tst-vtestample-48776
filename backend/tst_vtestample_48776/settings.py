"""
Django settings for tst_vtestample_48776 project.
...
ROOT_URLCONF = 'tst_vtestample_48776.urls'
...
WSGI_APPLICATION = 'tst_vtestample_48776.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "tst-Vtestample Support <support@tst-vtestample-48776.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_vtestample_48776 API",
    "DESCRIPTION": "API documentation for tst_vtestample_48776 App",
    "VERSION": "v1",
}
